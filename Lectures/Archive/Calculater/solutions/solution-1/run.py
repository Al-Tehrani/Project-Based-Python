...
Button(root,text="x^y",command= lambda :get_operation("**")).grid(row=5,column=4, sticky=N+S+E+W)
...
Button(root,text="=",command= lambda :calculate()).grid(row=5,column=5, sticky=N+S+E+W)
